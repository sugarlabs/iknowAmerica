...
CITIES = [
    ...
    (_('Delta del S. Juan'), 505, 258, 2, 60, 14),
    ...
    (_('Sta. Teresa'), 352, 303, 2, -20, -14),
    (_('Siquirres'), 558, 403, 2, -10, 14),
    (_('Sirena'), 554, 754, 2, -20, -14),
    (_('Sta. Cecilia'), 140, 179, 2, 20, -14),
