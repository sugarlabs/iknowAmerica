...
STATES = [
    ...
    (_('Valparaiso'), 250, 140, 683, 0),
    (_('Metropolitana'), 249, 154, 728, 0),
    (_("Lib. Gral. Bernardo O'Higgins"), 248, 158, 768, 0),
    (_('Maule'), 247, 118, 824, 0),
    (_('Bio-Bio'), 246, 510, 57, 0),
    (_('La Araucanía'), 245, 511, 133, 0),
    (_('Los Lagos'), 244, 496, 283, 0),
    (_('Aisén Gral. Carlos Ibáñez del Campo'), 243, 553, 481, 0),
...
STATS = [
    ...
    (_('GDP:'), _('USD 276.338 billion (43rd)')),
